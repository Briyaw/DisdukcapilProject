                                        ...
                                        <?php if ($n > 1) {
                                            ...
                                            <?php } else{ 
                                                if($this->session->userdata('role_id') == 4){
                                                    if(empty($_POST['from_date']) || empty($_POST['to_date']) || empty($_POST['des'])){ ?>
                                                        <p class="text-danger">Harap isi semua kolom yang diperlukan.</p>
                                                    <?php } else { ?>
                                                        <div>
                                                            <a  href="<?= base_url('cetak-surat-bpp/'. $data->id . '?nomor=' . $data->nomor_surat . '&from_date=' . $_POST['from_date'] . '&to_date=' . $_POST['to_date'] . '&des=' . $_POST['des']) ?> " class="btn btn-primary btn-lg " target="_blank"><i class="bi bi-printer-fill"></i></a>
                                                        </div>
                                                    <?php } ?>
                                                <?php } 
                                                    else{ 
