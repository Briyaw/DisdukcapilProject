            <div class="main-content container-fluid">
                <div class="page-title">
                    <h4>Priview Surat Domisili</h4>
                </div>
                <a href="<?= base_url('verifikasi-surat-domisili') ?>" class="btn btn-primary btn-sm mb-2"><i class="bi bi-arrow-left-circle-fill"></i> Kembali</a>
