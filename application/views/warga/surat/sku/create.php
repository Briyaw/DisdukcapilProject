                                    ...
                                    <form action="<?= base_url('sku/proses') ?>" method="post" enctype="multipart/form-data">
                                        <?php foreach ($data as $d) { ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nama_usaha" value="<?= set_value('nama_usaha') ?>" class="form-control">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <small class="text-danger">*Wajib !</small>
                                                <textarea name="alamat_usaha" id="" cols="30" rows="5" class="form-control" required><?= set_value('alamat') ?></textarea>
                                            </div>
                                            <div class="form-group">
